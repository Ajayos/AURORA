...
const makeMessagesDictionary = () => (0, dictionary_1.default)(exports.waMessageID);
exports.default = ({ logger: _logger, chatKey }) => {
    ...
    const KeyedDB = require('./KeyedDB').default;
    ...
    const fromJSON = (json) => {
        ...
        for (const jid in json.messages) {
            ...
            for (const msg of json.messages[jid]) {
                list.upsert(Proto_1.proto.WebMessageInfo.fromObject(msg), 'append');
            }
        }
    };
    return {
