...
export const Browsers = {
	...
	keerthana: browser => ['KEERTHANA', 'Safari', '109.0.5414.74'] as [string, string, string],
...
export const fetchLatestBaileysVersion = async(options: AxiosRequestConfig<any> = { }) => {
	const URL = 'https://raw.githubusercontent.com/Ajayos/Baileys/master/src/Defaults/baileys-version.json'
	try {
